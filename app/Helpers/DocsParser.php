...
class DocsParser
{
    ...
    public function getSection(string $slug): ?array
    {
        $aliases = [
            ...
            'cli'                    => '10-cli-console-51-built-in-commands',
            'commands'               => '10-cli-console-51-built-in-commands',
            'scaffolding'            => '10-cli-console-51-built-in-commands',
            ...
            'components'             => '20-veldora-ui-41-components',
            'ui'                     => '20-veldora-ui-41-components',
            'veldora-ui'             => '20-veldora-ui-41-components',
            '20-veldora-ui-21-components' => '20-veldora-ui-41-components',
