    ...
    <section class="features-section" aria-label="Features">
        ...
        <div class="features-grid">
            ...
            <article class="feature-card">
                ...
                <p class="feature-desc">Blade-inspired <code>@directives</code>, <code><?php echo htmlspecialchars((string) (expressions ?? ''), ENT_QUOTES, 'UTF-8'); ?></code>, layout inheritance, and reusable components.</p>
            </article>
            ...
            <article class="feature-card">
                ...
                <p class="feature-desc">Session guards, <code><?php if(auth()->check()): ?>/<?php if(auth()->guest()): ?></code> directives, CSRF protection, and a complete login/register scaffold.</p>
            </article>
