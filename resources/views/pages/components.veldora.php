...
@section('page_title', 'UI Components Catalog')
@section('page_title_suffix', 'Veldora')
@section('meta_desc', 'Explore 41+ production-ready Veldora UI components with multi-style variations, pure CSS animations, and live interactive previews.')
